...
def run_test_count_cosines_from():
    ...
    # Test 3:
    expected = 5
    answer = count_cosines_from(0, 9, 0.0)
    ...
    # Test 6:
    expected = 2
    answer = count_cosines_from(3, 9, 0.75)
...
def run_test_sum_unit_fractions_from():
    ...
    # ------------------------------------------------------------------
    # Test 2:
    expected = 25/12  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(1, 4)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
    # Test 3:
    expected = 49/20  # This is APPROXIMATELY the correct answer.
